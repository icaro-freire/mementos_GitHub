...
Vamos fazer um teste com o pdf do modelo de lista de atividade que estou desenvolvendo.
o nome do pdf é: `modelo_ativmatUFRB.pdf`, o qual está na pasta `docs`.
